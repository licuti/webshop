...
@section('content')
    ...
    <div class="container">
                ...
                <div class="list_cards">
                    ...
                    @foreach($show_suggest_product as $key => $suggest_product)
                        <div class="card_product">
                            <div class="product_favorite" id="{{'suggest'.$suggest_product->id_product}}" data-id_product="{{$suggest_product->id_product}}" data-id_user="{{Session::get('id_user')}}">
                                <i class="fa fa-heart-o" aria-hidden="true"></i>
                            </div>
                        <a href="{{URL::to('/chi-tiet-san-pham/'.$suggest_product->slug_product.'/'.$suggest_product->id_product)}}">
                            <div class="product_image">
                                <div class="img">
                                    <img src="{{asset('public/images_upload/images_product/'.$suggest_product->image_product)}}" alt="">
                                </div>
                            </div>
                            ...
                            <div class="card_content">
                                <div class="product_title">
                                    {{$suggest_product->name_product}}
                                </div>
                                <div class="card_price">
                                    <div class="product_current_price">
                                        <div class="current_price">
                                        <?php
                                            if ($suggest_product->discount_product > 0) {
                                                // code...
                                            $price = (float)$suggest_product->price_product;
                                            $percent = (float)$suggest_product->discount_product;
                                            $discount = $price - (($price * $percent) / 100);
                                            
                                            echo number_format($discount, 0, ',', '.').' VNĐ';
                                            }else{
                                                echo number_format($suggest_product->price_product, 0, ',', '.').' VNĐ';
                                            }
                                        ...
                                        <div class="discount_rate">
                                            <?php
                                                if ($suggest_product->discount_product > 0) {
                                                    echo $suggest_product->discount_product.'%';
                                                }else{
                                                    echo "";
                                                }
                                            ?>
                            ...
                            <div class="card_button">
                                <div class="btn_add_product addcartnow" data-id_product="{{$suggest_product->id_product}}">
                                    <div class="logo_btn_add_product">
                                        <i class="fas fa-cart-plus"></i>
                                    </div>
                                    Thêm giỏ hàng
                                </div>
                                <div class="btn_buy_product paynow" data-id_product="{{$suggest_product->id_product}}" >
                                    Mua Ngay
                                </div>
                            </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card_product" style="width: 100%;margin-left: 0px;">
                                    ...
                                    <div class="product_favorite" id="{{'hot'.$hot_product->id_product}}" data-id_product="{{$hot_product->id_product}}" data-id_user="{{Session::get('id_user')}}">
