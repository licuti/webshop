...
<div class="xs-pd-20-10 pd-ltr-20">
			...
			<div class="title pb-20">
				<h2 class="h3 mb-0">Thống kê trong tháng</h2>
			</div>
			...
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-15 text-dark">2342</div>
								<div class="font-14 text-secondary weight-500">Số lượng khách hàng</div>
							</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-15 text-dark">{{$qtyBill}}</div>
								<div class="font-14 text-secondary weight-500">Đơn hàng trong tháng</div>
							</div>
							<div class="widget-icon">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-15 text-dark">{{number_format($totalMonth,0,',','.')." VNĐ"}}</div>
								<div class="font-14 text-secondary weight-500">Doanh thu trong tháng</div>
							</div>
							<div class="widget-icon">
