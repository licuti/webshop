	...
	<div class="min-height-200px">
		...
		<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="{{URL::to('/save-blog')}}" enctype="multipart/form-data">
						...
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Thêm Blog</h4>
						...
						<div class="form-group">
							...
							<input class="form-control" name="title_blog" id="gettex_slug" onkeyup="ChangeToSlug()" type="text" placeholder="Tên danh mục" required>
						</div>
						<div class="form-group">
							<label>Slug bài viết</label>
							<input class="form-control" name="slug_blog" type="text" id="settex_slug" placeholder="Tên slug" required>							
						</div>

						<div class="form-group">
							<label>Tóm tắt bài viết</label>
							<textarea class="form-control" name="describe_blog" placeholder="Tên danh mục" required></textarea>
						</div>
						<div class="form-group">
							<label>Nội dung bài viết</label>
							<textarea class="form-control" id="editor_edit_product" name="content_blog"></textarea>
						</div>
